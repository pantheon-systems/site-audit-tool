...
class SecurityMenuRouter extends SiteAuditCheckBase {
  ...
  public function getDescription() {
    return $this->t("Check for potentially malicious entries in the menu router.");
  }
  ...
  public function getResultFail() {
    ...
    if ($this->registry->detail) {
      ...
      $ret_val .= $this->simpleKeyValueList($this->t('Path'), $this->t('Reason'), $this->registry->menu_router);
    }
    return $ret_val;
  }
